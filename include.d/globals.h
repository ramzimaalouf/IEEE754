...
#define ROUND_TESTS_START 1000
#define ROUND_TO_ZERO_TESTS_START ROUND_TESTS_START
#define ROUND_TO_NEAREST_TESTS_START ROUND_TESTS_START+50
#define ROUND_TO_NEGATIVE_TESTS_START ROUND_TO_NEAREST_TESTS_START+50
#define ROUND_TO_POSITIVE_TESTS_START ROUND_TO_NEGATIVE_TESTS_START+50
