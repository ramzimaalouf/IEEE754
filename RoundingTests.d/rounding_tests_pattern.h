...
static DoubleTestDescription DoubleArthmeticTestsToZero[e_ROUNDING_END_OF_LIST] = {
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD ,"ADD RD to ZERO double",0x3380000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT ,"SUBTRACT RD to ZERO double",0x3f80000000000000,0x3380000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY ,"MULTIPLY RD to ZERO double",0x3f80040000000000,0x3f80040000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE ,"DIVIDE RD to ZERO double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_REMAINDER ,"REMAINDER RD to ZERO double",0x3fffffff00000000,0x4000000100000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SQUAREROOT,"SQUARE ROOT RD to ZERO double",0x4000000000000000,0x3fb504f300000000,0,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD ,"Neg ADD RD to ZERO double",0xb380000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to ZERO double",0xbf80000000000000,0x3380000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to ZERO double",0x3f80040000000000,0xbf80040000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE ,"Neg DIVIDE RD to ZERO double",0xc080000000000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD_QUARTER ,"ADD 1/4 RD to ZERO double",0x3300000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT_QUARTER ,"SUBTRACT 1/4 RD to ZERO double",0x3f80000000000000,0x3300000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY_QUARTER ,"MULTIPLY 1/4 RD to ZERO double",0x3f80020000000000,0x3f80020000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE_QUARTER ,"DIVIDE 1/4 RD to ZERO double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD_THREE_QUARTER ,"ADD 3/4 RD to ZERO double",0x3340000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT_THREE_QUARTER ,"SUBTRACT 3/4 RD to ZERO double",0x3f80000000000000,0x3340000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY_THREE_QUARTER ,"MULTIPLY 3/4 RD to ZERO double",0x3f80050000000000,0x3f80050000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE_THREE_QUARTER ,"DIVIDE 3/4 RD to ZERO double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD_QUARTER ,"Neg ADD 1/4 RD to ZERO double",0xb300000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT_QUARTER ,"Neg SUBTRACT 1/4 RD to ZERO double",0xbf80000000000000,0x3300000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY_QUARTER ,"Neg MULTIPLY 1/4 RD to ZERO double",0x3f80020000000000,0xbf80020000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE_QUARTER ,"Neg DIVIDE 1/4 RD to ZERO double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD_THREE_QUARTER ,"Neg ADD 3/4 RD to ZERO double",0xb340000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT_THREE_QUARTER ,"Neg SUBTRACT 3/4 RD to ZERO double",0xbf80000000000000,0x3340000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY_THREE_QUARTER ,"Neg MULTIPLY 3/4 RD to ZERO double",0xbf80050000000000,0x3f80050000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE_THREE_QUARTER ,"Neg DIVIDE 3/4 RD to ZERO double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},

};

static DoubleTestDescription DoubleArthmeticTestsToNegativeInfinity[e_ROUNDING_END_OF_LIST] = {
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD ,"ADD RD to NEG INF double",0x3380000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT ,"SUBTRACT RD to NEG INF double",0x3f80000000000000,0x3380000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY ,"MULTIPLY RD to NEG INF double",0x3f80040000000000,0x3f80040000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE ,"DIVIDE RD to NEG INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_REMAINDER ,"REMAINDER RD to NEG INF double",0x3fffffff00000000,0x4000000100000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SQUAREROOT,"SQUARE ROOT RD to NEG INF double",0x4000000000000000,0x3fb504f300000000,0,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD ,"Neg ADD RD to NEG INF double",0xb380000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to NEG INF double",0xbf80000000000000,0x3380000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to NEG INF double",0x3f80040000000000,0xbf80040000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE ,"Neg DIVIDE RD to NEG INF double",0xc080000000000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD_QUARTER ,"ADD 1/4 RD to NEG INF double",0x3300000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT_QUARTER ,"SUBTRACT 1/4 RD to NEG INF double",0x3f80000000000000,0x3300000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY_QUARTER ,"MULTIPLY 1/4 RD to NEG INF double",0x3f80020000000000,0x3f80020000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE_QUARTER ,"DIVIDE 1/4 RD to NEG INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD_THREE_QUARTER ,"ADD 3/4 RD to NEG INF double",0x3340000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT_THREE_QUARTER ,"SUBTRACT 3/4 RD to NEG INF double",0x3f80000000000000,0x3340000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY_THREE_QUARTER ,"MULTIPLY 3/4 RD to NEG INF double",0x3f80050000000000,0x3f80050000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE_THREE_QUARTER ,"DIVIDE 3/4 RD to NEG INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD_QUARTER ,"Neg ADD 1/4 RD to NEG INF double",0xb300000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT_QUARTER ,"Neg SUBTRACT 1/4 RD to NEG INF double",0xbf80000000000000,0x3300000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY_QUARTER ,"Neg MULTIPLY 1/4 RD to NEG INF double",0x3f80020000000000,0xbf80020000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE_QUARTER ,"Neg DIVIDE 1/4 RD to NEG INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD_THREE_QUARTER ,"Neg ADD 3/4 RD to NEG INF double",0xb340000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT_THREE_QUARTER ,"Neg SUBTRACT 3/4 RD to NEG INF double",0xbf80000000000000,0x3340000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY_THREE_QUARTER ,"Neg MULTIPLY 3/4 RD to NEG INF double",0xbf80050000000000,0x3f80050000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE_THREE_QUARTER ,"Neg DIVIDE 3/4 RD to NEG INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},

};

static DoubleTestDescription DoubleArthmeticTestsToPositiveInfinity[e_ROUNDING_END_OF_LIST] = {
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD ,"ADD RD to POS INF double",0x3380000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT ,"SUBTRACT RD to POS INF double",0x3f80000000000000,0x3380000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY ,"MULTIPLY RD to POS INF double",0x3f80040000000000,0x3f80040000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE ,"DIVIDE RD to POS INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_REMAINDER ,"REMAINDER RD to POS INF double",0x3fffffff00000000,0x4000000100000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SQUAREROOT,"SQUARE ROOT RD to POS INF double",0x4000000000000000,0x3fb504f300000000,0,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD ,"Neg ADD RD to POS INF double",0xb380000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to POS INF double",0xbf80000000000000,0x3380000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to POS INF double",0x3f80040000000000,0xbf80040000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE ,"Neg DIVIDE RD to POS INF double",0xc080000000000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD_QUARTER ,"ADD 1/4 RD to POS INF double",0x3300000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT_QUARTER ,"SUBTRACT 1/4 RD to POS INF double",0x3f80000000000000,0x3300000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY_QUARTER ,"MULTIPLY 1/4 RD to POS INF double",0x3f80020000000000,0x3f80020000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE_QUARTER ,"DIVIDE 1/4 RD to POS INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_ADD_THREE_QUARTER ,"ADD 3/4 RD to POS INF double",0x3340000000000000,0x3f80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_SUBTRACT_THREE_QUARTER ,"SUBTRACT 3/4 RD to POS INF double",0x3f80000000000000,0x3340000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_MULTIPLY_THREE_QUARTER ,"MULTIPLY 3/4 RD to POS INF double",0x3f80050000000000,0x3f80050000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_DIVIDE_THREE_QUARTER ,"DIVIDE 3/4 RD to POS INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD_QUARTER ,"Neg ADD 1/4 RD to POS INF double",0xb300000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT_QUARTER ,"Neg SUBTRACT 1/4 RD to POS INF double",0xbf80000000000000,0x3300000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY_QUARTER ,"Neg MULTIPLY 1/4 RD to POS INF double",0x3f80020000000000,0xbf80020000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE_QUARTER ,"Neg DIVIDE 1/4 RD to POS INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_ADD_THREE_QUARTER ,"Neg ADD 3/4 RD to POS INF double",0xb340000000000000,0xbf80000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_SUBTRACT_THREE_QUARTER ,"Neg SUBTRACT 3/4 RD to POS INF double",0xbf80000000000000,0x3340000000000000,0xffffffffffffffff,0},
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_MULTIPLY_THREE_QUARTER ,"Neg MULTIPLY 3/4 RD to POS INF double",0xbf80050000000000,0x3f80050000000000,0xffffffffffffffff,0}, 
 { ROUND_TO_NEAREST_TESTS_START_DOUBLE+e_NEGATIVE_DIVIDE_THREE_QUARTER ,"Neg DIVIDE 3/4 RD to POS INF double",0x3f80000100000000,0x4000000000000000,0xffffffffffffffff,0},
