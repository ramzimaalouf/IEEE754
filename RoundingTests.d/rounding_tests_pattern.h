...
static FloatTestDescription FloatArthmeticTestsToZero[e_ROUNDING_END_OF_LIST] = {
 { ROUND_TO_ZERO_TESTS_START+e_ADD ,"ADD RD to ZERO float",0x34000000,0x40000000,0x40000000,0},
 { ROUND_TO_ZERO_TESTS_START+e_SUBTRACT ,"SUBTRACT RD to ZERO float",0x40000000,0x34000000,0x3f800000,0},
 { ROUND_TO_ZERO_TESTS_START+e_MULTIPLY ,"MULTIPLY RD to ZERO float",0x40000000,0x40000000,0xffffffff,0}, 
 { ROUND_TO_ZERO_TESTS_START+e_DIVIDE ,"DIVIDE RD to ZERO float",0x40800000,0x40000000,0xffffffff,0},
 ...
 { ROUND_TO_ZERO_TESTS_START+e_NEGATIVE_ADD ,"Neg ADD RD to ZERO float",0xb8000000,0xc0000000,0xc0000000,0},
 { ROUND_TO_ZERO_TESTS_START+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to ZERO float",0xc0000000,0xb4000000,0xbf800000,0},
 { ROUND_TO_ZERO_TESTS_START+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to ZERO float",0xc0000000,0xc0000000,0xc0800000,0},
...
static FloatTestDescription FloatArthmeticTestsToNegativeInfinity[e_ROUNDING_END_OF_LIST] = {
 ...
 { ROUND_TO_NEGATIVE_TESTS_START+e_NEGATIVE_ADD ,"Neg ADD RD to ZERO float",0xa8000000,0xc0800000,0xc0000000,0},
 { ROUND_TO_NEGATIVE_TESTS_START+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to Negative Infinity float",0xc0000000,0x3f800000,0x3f800000,0},
 { ROUND_TO_NEGATIVE_TESTS_START+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to Negative Infinity float",0xc0000000,0x40000000,0x40800000,0},
 { ROUND_TO_NEGATIVE_TESTS_START+e_NEGATIVE_DIVIDE ,"Neg DIVIDE RD to Negative Infinity float",0xc0800000,0x40000000,0x40000000,0},
};
...
static FloatTestDescription FloatArthmeticTestsToPositiveInfinity[e_ROUNDING_END_OF_LIST] = {
 ...
 { ROUND_TO_POSITIVE_TESTS_START+e_NEGATIVE_ADD ,"Neg ADD RD to ZERO float",0xa8000000,0xc0000000,0xc0000000,0},
 { ROUND_TO_POSITIVE_TESTS_START+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to POSITIVE INFINITY float",0xc0000000,0x3f800000,0x3f800000,0},
 { ROUND_TO_POSITIVE_TESTS_START+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to POSITIVE INFINITY float",0xc0000000,0x40000000,0x40800000,0},
 { ROUND_TO_POSITIVE_TESTS_START+e_NEGATIVE_DIVIDE ,"Neg DIVIDE RD to POSITIVE INFINITY float",0xc0800000,0x40000000,0x40000000,0},
};
...
static FloatTestDescription FloatArthmeticTestsToNearest[e_ROUNDING_END_OF_LIST] = {
 ...
 { ROUND_TO_NEAREST_TESTS_START+e_NEGATIVE_ADD ,"Neg ADD RD to ZERO float",0xa8000000,0xc0000000,0xc0000000,0},
 { ROUND_TO_NEAREST_TESTS_START+e_NEGATIVE_SUBTRACT ,"Neg SUBTRACT RD to NEAREST float",0xc0000000,0x3f800000,0x3f800000,0},
 { ROUND_TO_NEAREST_TESTS_START+e_NEGATIVE_MULTIPLY ,"Neg MULTIPLY RD to NEAREST float",0xc0000000,0x40000000,0x40800000,0},
 { ROUND_TO_NEAREST_TESTS_START+e_NEGATIVE_DIVIDE ,"Neg DIVIDE RD to NEAREST float",0xc0800000,0x40000000,0x40000000,0},
